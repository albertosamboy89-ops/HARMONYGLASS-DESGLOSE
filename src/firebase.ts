...
// Habilitar la persistencia sin conexión (IndexedDB)
...
async function testConnection() {
  try {
    ...
    if (error instanceof Error && error.message.includes('the client is offline')) {
      console.error("Please check your Firebase configuration. You might be offline or the rules are too restrictive.");
    }
  }
}
testConnection();
